...
abstract class ConfigReader{
  ...
  static Future<void> initialize() async {
    final responseStringAR = await rootBundle.loadString("assets/local/locale_ar.json");
    final responseStringEN = await rootBundle.loadString("assets/local/locale_en.json");
